package ua.unitfactory.swingy.storage;
    ...
    public ArrayList<Hero> selectFromTable() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                Hero hero = CharactherFactory.createNewHero(rs.getString("name"), CharactherFactory.Factory(rs.getString("type")), armor, helm, weapon);
