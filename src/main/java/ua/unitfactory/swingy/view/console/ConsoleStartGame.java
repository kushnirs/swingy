package ua.unitfactory.swingy.view.console;

import ua.unitfactory.swingy.controller.GamePlayController;
import ua.unitfactory.swingy.Main;
import ua.unitfactory.swingy.controller.CharactherController;
...
public class ConsoleStartGame {
    ...
    private int selectHero() {
        ...
        int type = GamePlayController.readNbr(0, i,"Choose type of hero and add appropriate number: ","\u001B[31mMust be from 0 to " + i + "\u001B[0m");

        if (type == 0) {
            new GuiStartGame().showSelectHero();
            return 0;
        }

        Main.hero = GuiStartGame.heroDB.get(type - 1);
        return 1;
    }
